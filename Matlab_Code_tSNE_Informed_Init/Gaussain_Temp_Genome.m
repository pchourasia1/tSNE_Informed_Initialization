...
gaussian_kernel = csvread("C:/Users/pchourasia1/Desktop/tSne_extension/kernel_matrix/genome/approximate_kernel_matrix.csv");
% initializaed_ica = csvread("C:/Users/pchourasia1/Desktop/tSne_extension/tSNE_matrix_genome_data/Approximate/ica_2d.csv");
% 
% for i= 100:100:2001
%     tic   
...
%     
%     csvwrite("C:/Users/pchourasia1/Desktop/tSne_extension/tSNE_matrix_ica/genome/Approximate/approximate_tsne_kmer_matlab_2d_"+i+"_.csv",y_gaussian_kernel);
% 
% end
% 
% disp("Starting Approximate - PCA");
% initializaed_pca = csvread("C:/Users/pchourasia1/Desktop/tSne_extension/tSNE_matrix_genome_data/Approximate/pca_2d.csv");
% for i= 100:100:2001
%     tic
...
%     disp(strcat("Time consumed for Approximate kernel to tSNE: ", num2str(time_isolation)));
%     
%     csvwrite("C:/Users/pchourasia1/Desktop/tSne_extension/tSNE_matrix_pca/genome/Approximate/approximate_tsne_kmer_matlab_2d_"+i+"_.csv",y_gaussian_kernel);
% end

disp("Starting Approximate - Ensemble");
initializaed_ensemble = csvread("C:/Users/pchourasia1/Desktop/tSne_extension/tSNE_matrix_genome_data/Approximate/ensemble_2d.csv");
for i= 100:100:2001
    tic
    ...
    csvwrite("C:/Users/pchourasia1/Desktop/tSne_extension/tSNE_matrix_ensemble/genome/Approximate/approximate_tsne_kmer_matlab_2d_"+i+"_.csv",y_gaussian_kernel);
end

disp("Starting Approximate - Random");
initializaed_ensemble = csvread("C:/Users/pchourasia1/Desktop/tSne_extension/tSNE_matrix_genome_data/Approximate/random_init_tsne_2_dim.csv");
for i= 100:100:2001
    tic
    y_gaussian_kernel = tsne_p(gaussian_kernel, 2, i, initializaed_ensemble);
    ...
    csvwrite("C:/Users/pchourasia1/Desktop/tSne_extension/tSNE_matrix_random/genome/Approximate/approximate_tsne_kmer_matlab_2d_"+i+"_.csv",y_gaussian_kernel);
end
