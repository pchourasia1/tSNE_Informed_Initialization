...
disp("Starting Approximate - ICA");
isolated_kernel = csvread("C:/Users/pchourasia1/Desktop/tSne_extension/kernel_matrix/host/approximate_kernel_matrix.csv");
% initializaed_ica = csvread("C:/Users/pchourasia1/Desktop/tSne_extension/tSNE_matrix_genome_data/Isolated/ica_2d.csv");
...
%     
%     csvwrite("C:/Users/pchourasia1/Desktop/tSne_extension/tSNE_matrix_ica/genome/Isolated/isolated_tsne_kmer_matlab_2d_"+i+"_.csv",y_gaussian_kernel);
% 
% end

disp("Starting Approximate - PCA");
initializaed_pca = csvread("C:/Users/pchourasia1/Desktop/tSne_extension/tSNE_matrix_host_data/Approximate/pca_2d.csv");
for i= 100:100:2001
    tic
    y_gaussian_kernel = tsne_p(isolated_kernel, 2, i, initializaed_pca/100);
    
    time_isolation = toc;
    disp(strcat("Time consumed for approximate kernel to tSNE: ", num2str(time_isolation)));
    
    csvwrite("C:/Users/pchourasia1/Desktop/tSne_extension/tSNE_matrix_pca/host/ApproximateV2/approximate_tsne_kmer_matlab_2d_"+i+"_.csv",y_gaussian_kernel);
end

% disp("Starting Approximate - Ensemble");
% initializaed_ensemble = csvread("C:/Users/pchourasia1/Desktop/tSne_extension/tSNE_matrix_host_data/Approximate/ensemble_2d.csv");
% for i= 100:100:2001
%     tic
%     y_gaussian_kernel = tsne_p(isolated_kernel, 2, i, initializaed_ensemble);
%     
%     time_isolation = toc;
%     disp(strcat("Time consumed for approximate kernel to tSNE: ", num2str(time_isolation)));
%     
%     csvwrite("C:/Users/pchourasia1/Desktop/tSne_extension/tSNE_matrix_ensemble/host/Approximate/approximate_tsne_kmer_matlab_2d_"+i+"_.csv",y_gaussian_kernel);
% end

% disp("Starting Isolated - Random");
% initializaed_ensemble = csvread("C:/Users/pchourasia1/Desktop/tSne_extension/tSNE_matrix_host_data/Isolated/random_init_tsne_2_dim.csv");
% for i= 100:100:2001
%     tic
%     y_gaussian_kernel = tsne_p(isolated_kernel, 2, i, initializaed_ensemble);
%     
...
%     disp(strcat("Time consumed for isolated kernel to tSNE: ", num2str(time_isolation)));
%     
%     csvwrite("C:/Users/pchourasia1/Desktop/tSne_extension/tSNE_matrix_random/host/Isolated/isolated_tsne_kmer_matlab_2d_"+i+"_.csv",y_gaussian_kernel);
% end
...
%     disp(strcat("Time consumed for laplacian kernel to tSNE: ", num2str(time_isolation)));
%     
%     csvwrite("C:/Users/pchourasia1/Desktop/tSne_extension/tSNE_matrix_random/circle/Laplacian/laplacian_tsne_kmer_matlab_2d_"+i+"_.csv",y_isolated_kernel);
% end
