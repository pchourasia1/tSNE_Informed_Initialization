function ydata = tsne_p(P, no_dims, max_iter, initializaed_ica)
...
%         [ V, eigvalueSum ] = fld( P, labels, 2 )
%         ydata = V;
        ydata =  initializaed_ica;
%         [Y,eigvals] = cmdscale(P);
%         ydata = [eigvals eigvals/max(abs(eigvals))]
%         rica(P,no_dims, 'Standardize',true)
    end
%     ydata = pca(P,'NumComponents',no_dims)
% fea = rand(50,70);
